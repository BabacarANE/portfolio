...
export const projects = [
    {
        ...
        description: 'Plateforme de vente en ligne complète avec gestion des produits, panier d\'achat et système de commandes.',
        image: '/images/ecommerce.png',
        technologies: ['Laravel', 'Vue.js', 'PGAdmin'],
        liveLink: '#',
        githubLink: 'https://github.com/BabacarANE/Sultan_High_Tech.git',
        role: 'Développeur Full-Stack',
        duration: '3 mois',
        details: 'Développement d\'un site e-commerce avec backend Laravel, frontend Vue.js et base de données PostgreSQL. Gestion des utilisateurs, produits, commandes et paiements.'
    },
    {
        id: 2,
